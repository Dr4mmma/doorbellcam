...
known_face_metadata = []
alarmnum = []
client = Client("ACd186263f304e6da3fe3052b82501ec43", "5ae064888c4ac992240372e98abcde8f")

mp3File = 'alarm.mp3'
from_whatsapp_number='whatsapp:+14155238886'
to_whatsapp_number='whatsapp:+962789972731'
    ...
    while True:
        ...
        for face_location, face_encoding in zip(face_locations, face_encodings):
            ...
            if metadata is not None:
                time_at_door = datetime.now() - time1
                if keyboard.is_pressed('b'):
                    time1 = datetime.now()
                if int(time_at_door.total_seconds()) == 60:
                    cv2.putText(frame, "Something is wrong", (right + 6, bottom - 6), cv2.FONT_HERSHEY_DUPLEX, 0.8,
                                (255, 255, 255), 1)
                    img_name = "Strange person_{}.png".format(img_counter)
                    ...
                    playsound(mp3File)
                    if len(alarmnum) == 2:
                        client.messages.create(body='Check out this picture of a strange person on your door!',
                                               media_url='c',
